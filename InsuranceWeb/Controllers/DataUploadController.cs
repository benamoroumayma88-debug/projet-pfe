                ...
                try
                {
                    foreach (var row in rows)
                    {
                        ...
                        for (int i = 0; i < columns.Count; i++)
                        {
                            ...
                            // Handle NULL/empty values intelligently
                            ...
                            else if (columnName == "Montant_Indemnisation_Claim")
                            {
                                // For compensation amount, use 0 if empty
                                paramValue = 0;
                            }
                            else if (columnName == "Montant_Estime_Dommage_Claim")
                            {
                                // For estimated damage, use 0 if empty
                                paramValue = 0;
                            }
                            else if (columnName == "Duree_Traitement_Jours" || columnName == "Duree_Traitement_Heures")
                            {
                                // For duration fields, use 0 if empty
                                paramValue = 0;
                            }
                            else if (columnName == "SLA_Jours")
                            {
                                // For SLA days, use 0 if empty
                                paramValue = 0;
                            }
